...
return(
        ...
        <div><input ref={profileref}  type="text" placeholder="Enter your profile image address" required/></div>
        <br/>
        <div><input ref={storyref} type="text" placeholder="enter your story image address"required/></div> 
        <br/>
        <div><input ref={nameeref} type="text" placeholder="Enter your name" required/></div>
        <br/>
